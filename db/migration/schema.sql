...
CREATE TABLE `response_code` (
  `RCODE` varchar(11) NOT NULL DEFAULT '0',
  `RCTYPE` varchar(30) NOT NULL DEFAULT 'GLOBAL',
  `RCODE_CLIENT` varchar(11) DEFAULT NULL,
  `MESSAGE_ID` varchar(255) DEFAULT NULL,
  `MESSAGE_EN` varchar(255) DEFAULT NULL,
  `STATUS` varchar(5) DEFAULT NULL,
  PRIMARY KEY (`RCODE`,`RCTYPE`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

CREATE TABLE `rekon_idproduk` (
  `IDPRODUK` int(11) NOT NULL AUTO_INCREMENT,
  `IDPRODUK_PPOB` varchar(255) DEFAULT NULL,
  `NAMA` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`IDPRODUK`)
) ENGINE=InnoDB AUTO_INCREMENT=1000001 DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci ROW_FORMAT=DYNAMIC;
